...
public class GetUsersEndpointTests : TestServiceBase
{
        ...
        List<IrasUser> users)
    {
        ...
        var expectedUsers = users
            ...
            .Take(pageSize)
            .Select(u => new UserDto(u.Id, u.GivenName, u.FamilyName, u.Email!, u.IdentityProviderId, u.Title, u.JobTitle, u.Organisation, u.Telephone, u.Country, u.Status, u.LastUpdated, u.CurrentLogin, u.LastUpdated));
